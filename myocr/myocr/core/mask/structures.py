...
from mycv.ops.roi_align import roi_align
...
class BaseInstanceMasks(metaclass=ABCMeta):
    ...
    def rescale(self, scale, interpolation='nearest'):
        ...
        For details can refer to `mycv.imrescale`.

        Args:
            scale (tuple[int]): The maximum size (h, w) of rescaled mask.
            interpolation (str): Same as :func:`mycv.imrescale`.
    ...
    def resize(self, out_shape, interpolation='nearest'):
        ...
        Args:
            ...
            interpolation (str): See :func:`mycv.imresize`.
    ...
    def crop_and_resize(self,
        ...
        Args:
            ...
            interpolation (str): See `mycv.imresize`
    ...
    def translate(self,
        ...
        Args:
            ...
            interpolation (str): Same as :func:`mycv.imtranslate`.
    ...
    def shear(self,
        ...
        Args:
            ...
            interpolation (str): Same as in :func:`mycv.imshear`.
...
class BitmapMasks(BaseInstanceMasks):
    ...
    def rescale(self, scale, interpolation='nearest'):
        ...
        if len(self.masks) == 0:
            new_w, new_h = mycv.rescale_size((self.width, self.height), scale)
            rescaled_masks = np.empty((0, new_h, new_w), dtype=np.uint8)
        else:
            rescaled_masks = np.stack([
                mycv.imrescale(mask, scale, interpolation=interpolation)
    ...
    def flip(self, flip_direction='horizontal'):
        ...
        if len(self.masks) == 0:
            ...
            flipped_masks = np.stack([
                mycv.imflip(mask, direction=flip_direction)
                for mask in self.masks
            ])
    ...
    def pad(self, out_shape, pad_val=0):
        ...
        if len(self.masks) == 0:
            ...
            padded_masks = np.stack([
                mycv.impad(mask, shape=out_shape, pad_val=pad_val)
                for mask in self.masks
            ])
    ...
    def translate(self,
        ...
        if len(self.masks) == 0:
            ...
            translated_masks = mycv.imtranslate(
