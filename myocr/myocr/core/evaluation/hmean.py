...
from myocr.myocr.core.evaluation import hmean_ic13, hmean_iou
from myocr.myocr.core.evaluation.utils import (filter_2dlist_result,
                                               select_top_boundary)
from myocr.myocr.core.maskocr import extract_boundary
...
def output_ranklist(img_results, img_infos, out_file):
    ...
    mycv.dump(sorted_results, file=out_file)
