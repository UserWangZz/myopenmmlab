...
import mycv
import numpy as np
from myocr.myocr.datasets.api_wrappers import COCO
from myocr.myocr.datasets.builder import DATASETS
from myocr.myocr.datasets.coco import CocoDataset

import myocr.myocr.utils as utils
from myocr.myocr import digit_version
from myocr.myocr.core.evaluation.hmean import eval_hmean
...
class IcdarDataset(CocoDataset):
    ...
    def load_annotations(self, ann_file):
        ...
        if self.ann_file_backend == 'disk':
            ...
            mmcv_version = digit_version(mycv.__version__)
            ...
            file_client = mycv.FileClient(backend=self.ann_file_backend)
